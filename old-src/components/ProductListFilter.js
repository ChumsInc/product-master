...
import {formatUPC} from '../../src/utils/upc';
...
import SeasonDropDown from "../../src/ducks/seasons/SeasonDropDown";
            ...
            <div>
                <div className="form-inline">
                    ...
                    <FormGroup label="Season">
                        <SeasonDropDown onSelect={(season) => this.props.setProductListUI({season})} value={season || ''} />
                    </FormGroup>
                    <FormGroup label="Season">
